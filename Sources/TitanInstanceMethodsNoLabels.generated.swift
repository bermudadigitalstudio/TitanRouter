...
extension Titan {
  ...
  public func allMethods(_ path: String, _ handler: @escaping (inout Request, inout Response) -> Void) {
    self.allMethods(path: path, handler: handler)
  }

  public func allMethods(_ path: String, _ handler: @escaping (inout Request, inout Response) -> (RequestType, ResponseType)) {
    self.allMethods(path: path, handler: handler)
  }
